...
const Routes = () => {
  return (
    <Switch>
      ...
      <RouteWithLayout component={ProjectsListView} exact layout={MainLayout}path="/projects" />
      <RouteWithLayout component={CustomerListView} exact layout={MainLayout} path="/customers" />
      <RouteWithLayout component={UserCardsView} exact layout={MainLayout}path="/users" />
